...
INSERT INTO план_дисциплин(Тип_занятия_id, Дисциплина_id,
   Учебный_план_Год_поступления, Учебный_план_Профиль_id,
    Запланированно_часов, Номер_семестра)
    SELECT Тип_занятия.id, Дисциплина.id, Учебный_план.Год_поступления,
    Учебный_план.Профиль_id, 12, 4
    FROM Тип_занятия, Дисциплина, Учебный_план
    WHERE Тип_занятия.Название = "Практика"
    AND Дисциплина.Название = "Базы данных"
    AND Учебный_план.Год_поступления = 2019
    AND Учебный_план.Профиль_id = (SELECT Профиль.id FROM Профиль WHERE Название = "Программная инженерия")
    ;
...
INSERT INTO план_дисциплин(Тип_занятия_id, Дисциплина_id,
   Учебный_план_Год_поступления, Учебный_план_Профиль_id,
    Запланированно_часов, Номер_семестра)
    SELECT Тип_занятия.id, Дисциплина.id, Учебный_план.Год_поступления,
    Учебный_план.Профиль_id, 2, 4
    FROM Тип_занятия, Дисциплина, Учебный_план
    WHERE Тип_занятия.Название = "Курсовая"
    AND Дисциплина.Название = "Базы данных"
    AND Учебный_план.Год_поступления = 2019
    AND Учебный_план.Профиль_id = (SELECT Профиль.id FROM Профиль WHERE Название = "Программная инженерия")
    ;
...
INSERT INTO занятие (План_дисциплин_id, Преподаватель_id, Дата,
   Номер_пары, Группа_id, Тема)
   SELECT 6, Преподаватель.id, '2021-05-04',
   3, Группа.id, 'БД'
   FROM Преподаватель, Группа
   WHERE Преподаватель.Имя = 'Денис' AND
   Преподаватель.Фамилия = 'Рыженков' AND
...
/* INSERT INTO посещаемость(Студент_Зачетка, Занятие_План_дисциплин_id, Занятие_Преподаватель_id, 
							Занятие_Дата, Занятие_Номер_пары, Занятие_Группа_id)
  SELECT <Зачетка>, Занятие.План_дисциплин_id, Занятие.Преподаватель_id, <Дата>, <Номерпары>, Занятие.Группа_id
  FROM Занятие
  ...
  WHERE Группа.Шифр = '<шифр>' AND
  Дисциплина.Название = '<>' AND
  Преподаватель.Имя = '<>' AND
  Преподаватель.Фамилия = '<>' AND
  Тип_занятия.Название = '<>'
;
...
INSERT INTO посещаемость(Студент_Зачетка, Занятие_План_дисциплин_id, Занятие_Преподаватель_id, 
							Занятие_Дата, Занятие_Номер_пары, Занятие_Группа_id)
	SELECT 191010, Занятие.План_дисциплин_id, Занятие.Преподаватель_id, '2021-05-01', 1, Занятие.Группа_id
	FROM Занятие
	JOIN План_дисциплин ON План_дисциплин.id = Занятие.План_дисциплин_id
	JOIN Дисциплина ON Дисциплина.id = План_дисциплин.Дисциплина_id
	JOIN Тип_занятия ON Тип_занятия.id = План_дисциплин.Тип_занятия_id
	JOIN Преподаватель ON Преподаватель.id = Занятие.Преподаватель_id
	JOIN Группа ON Группа.id = Занятие.Группа_id
	WHERE Группа.Шифр = '91ПГ' AND
	Дисциплина.Название = 'Базы данных' AND
	Преподаватель.Имя = 'Денис' AND
	Преподаватель.Фамилия = 'Рыженков' AND
	Тип_занятия.Название = 'Лекция'
	;

INSERT INTO посещаемость(Студент_Зачетка, Занятие_План_дисциплин_id, Занятие_Преподаватель_id, 
							Занятие_Дата, Занятие_Номер_пары, Занятие_Группа_id)
	SELECT 191011, Занятие.План_дисциплин_id, Занятие.Преподаватель_id, '2021-05-01', 1, Занятие.Группа_id
	FROM Занятие
	JOIN План_дисциплин ON План_дисциплин.id = Занятие.План_дисциплин_id
	JOIN Дисциплина ON Дисциплина.id = План_дисциплин.Дисциплина_id
	JOIN Тип_занятия ON Тип_занятия.id = План_дисциплин.Тип_занятия_id
...
INSERT INTO посещаемость(Студент_Зачетка, Занятие_План_дисциплин_id, Занятие_Преподаватель_id, 
							Занятие_Дата, Занятие_Номер_пары, Занятие_Группа_id)
	SELECT 191888, Занятие.План_дисциплин_id, Занятие.Преподаватель_id, '2021-05-01', 1, Занятие.Группа_id
	FROM Занятие
	JOIN План_дисциплин ON План_дисциплин.id = Занятие.План_дисциплин_id
	JOIN Дисциплина ON Дисциплина.id = План_дисциплин.Дисциплина_id
	JOIN Тип_занятия ON Тип_занятия.id = План_дисциплин.Тип_занятия_id
...
INSERT INTO посещаемость(Студент_Зачетка, Занятие_План_дисциплин_id, Занятие_Преподаватель_id, 
							Занятие_Дата, Занятие_Номер_пары, Занятие_Группа_id)
	SELECT 191001, Занятие.План_дисциплин_id, Занятие.Преподаватель_id, '2021-05-01', 1, Занятие.Группа_id
	FROM Занятие
	JOIN План_дисциплин ON План_дисциплин.id = Занятие.План_дисциплин_id
	JOIN Дисциплина ON Дисциплина.id = План_дисциплин.Дисциплина_id
	JOIN Тип_занятия ON Тип_занятия.id = План_дисциплин.Тип_занятия_id
...
INSERT INTO посещаемость(Студент_Зачетка, Занятие_План_дисциплин_id, Занятие_Преподаватель_id, 
							Занятие_Дата, Занятие_Номер_пары, Занятие_Группа_id)
	SELECT 191010, Занятие.План_дисциплин_id, Занятие.Преподаватель_id, '2021-05-01', 2, Занятие.Группа_id
	FROM Занятие
	JOIN План_дисциплин ON План_дисциплин.id = Занятие.План_дисциплин_id
	JOIN Дисциплина ON Дисциплина.id = План_дисциплин.Дисциплина_id
	JOIN Тип_занятия ON Тип_занятия.id = План_дисциплин.Тип_занятия_id
	...
	Преподаватель.Имя = 'Денис' AND
	Преподаватель.Фамилия = 'Рыженков' AND
	Тип_занятия.Название = 'Лабораторная работа'
	;

INSERT INTO посещаемость(Студент_Зачетка, Занятие_План_дисциплин_id, Занятие_Преподаватель_id, 
							Занятие_Дата, Занятие_Номер_пары, Занятие_Группа_id)
	SELECT 191011, Занятие.План_дисциплин_id, Занятие.Преподаватель_id, '2021-05-01', 2, Занятие.Группа_id
	FROM Занятие
	JOIN План_дисциплин ON План_дисциплин.id = Занятие.План_дисциплин_id
	JOIN Дисциплина ON Дисциплина.id = План_дисциплин.Дисциплина_id
	JOIN Тип_занятия ON Тип_занятия.id = План_дисциплин.Тип_занятия_id
...
INSERT INTO посещаемость(Студент_Зачетка, Занятие_План_дисциплин_id, Занятие_Преподаватель_id, 
							Занятие_Дата, Занятие_Номер_пары, Занятие_Группа_id)
	SELECT 191888, Занятие.План_дисциплин_id, Занятие.Преподаватель_id, '2021-05-01', 2, Занятие.Группа_id
	FROM Занятие
	JOIN План_дисциплин ON План_дисциплин.id = Занятие.План_дисциплин_id
	JOIN Дисциплина ON Дисциплина.id = План_дисциплин.Дисциплина_id
	JOIN Тип_занятия ON Тип_занятия.id = План_дисциплин.Тип_занятия_id
...
INSERT INTO посещаемость(Студент_Зачетка, Занятие_План_дисциплин_id, Занятие_Преподаватель_id, 
							Занятие_Дата, Занятие_Номер_пары, Занятие_Группа_id)
	SELECT 191001, Занятие.План_дисциплин_id, Занятие.Преподаватель_id, '2021-05-02', 1, Занятие.Группа_id
	FROM Занятие
	JOIN План_дисциплин ON План_дисциплин.id = Занятие.План_дисциплин_id
	JOIN Дисциплина ON Дисциплина.id = План_дисциплин.Дисциплина_id
	JOIN Тип_занятия ON Тип_занятия.id = План_дисциплин.Тип_занятия_id
...
INSERT INTO посещаемость(Студент_Зачетка, Занятие_План_дисциплин_id, Занятие_Преподаватель_id, 
							Занятие_Дата, Занятие_Номер_пары, Занятие_Группа_id)
	SELECT 191010, Занятие.План_дисциплин_id, Занятие.Преподаватель_id, '2021-05-01', 3, Занятие.Группа_id
	FROM Занятие
	JOIN План_дисциплин ON План_дисциплин.id = Занятие.План_дисциплин_id
	JOIN Дисциплина ON Дисциплина.id = План_дисциплин.Дисциплина_id
	JOIN Тип_занятия ON Тип_занятия.id = План_дисциплин.Тип_занятия_id
	...
	JOIN Группа ON Группа.id = Занятие.Группа_id
	WHERE Группа.Шифр = '91ПГ' AND
	Дисциплина.Название = 'Язык программирования C#' AND
	Преподаватель.Имя = 'Антон' AND
	Преподаватель.Фамилия = 'Ужаринский' AND
	Тип_занятия.Название = 'Лекция'
	;
...
INSERT INTO посещаемость(Студент_Зачетка, Занятие_План_дисциплин_id, Занятие_Преподаватель_id, 
							Занятие_Дата, Занятие_Номер_пары, Занятие_Группа_id)
	SELECT 191011, Занятие.План_дисциплин_id, Занятие.Преподаватель_id, '2021-05-01', 3, Занятие.Группа_id
	FROM Занятие
	JOIN План_дисциплин ON План_дисциплин.id = Занятие.План_дисциплин_id
	JOIN Дисциплина ON Дисциплина.id = План_дисциплин.Дисциплина_id
	JOIN Тип_занятия ON Тип_занятия.id = План_дисциплин.Тип_занятия_id
...
INSERT INTO посещаемость(Студент_Зачетка, Занятие_План_дисциплин_id, Занятие_Преподаватель_id, 
							Занятие_Дата, Занятие_Номер_пары, Занятие_Группа_id)
	SELECT 191888, Занятие.План_дисциплин_id, Занятие.Преподаватель_id, '2021-05-01', 3, Занятие.Группа_id
	FROM Занятие
	JOIN План_дисциплин ON План_дисциплин.id = Занятие.План_дисциплин_id
	JOIN Дисциплина ON Дисциплина.id = План_дисциплин.Дисциплина_id
	JOIN Тип_занятия ON Тип_занятия.id = План_дисциплин.Тип_занятия_id
...
INSERT INTO посещаемость(Студент_Зачетка, Занятие_План_дисциплин_id, Занятие_Преподаватель_id, 
							Занятие_Дата, Занятие_Номер_пары, Занятие_Группа_id)
	SELECT 191010, Занятие.План_дисциплин_id, Занятие.Преподаватель_id, '2021-05-02', 1, Занятие.Группа_id
	FROM Занятие
	JOIN План_дисциплин ON План_дисциплин.id = Занятие.План_дисциплин_id
	JOIN Дисциплина ON Дисциплина.id = План_дисциплин.Дисциплина_id
	JOIN Тип_занятия ON Тип_занятия.id = План_дисциплин.Тип_занятия_id
...
INSERT INTO посещаемость(Студент_Зачетка, Занятие_План_дисциплин_id, Занятие_Преподаватель_id, 
							Занятие_Дата, Занятие_Номер_пары, Занятие_Группа_id)
	SELECT 191011, Занятие.План_дисциплин_id, Занятие.Преподаватель_id, '2021-05-02', 1, Занятие.Группа_id
	FROM Занятие
	JOIN План_дисциплин ON План_дисциплин.id = Занятие.План_дисциплин_id
	JOIN Дисциплина ON Дисциплина.id = План_дисциплин.Дисциплина_id
	JOIN Тип_занятия ON Тип_занятия.id = План_дисциплин.Тип_занятия_id
...
INSERT INTO посещаемость(Студент_Зачетка, Занятие_План_дисциплин_id, Занятие_Преподаватель_id, 
							Занятие_Дата, Занятие_Номер_пары, Занятие_Группа_id)
	SELECT 191888, Занятие.План_дисциплин_id, Занятие.Преподаватель_id, '2021-05-02', 1, Занятие.Группа_id
	FROM Занятие
	JOIN План_дисциплин ON План_дисциплин.id = Занятие.План_дисциплин_id
	JOIN Дисциплина ON Дисциплина.id = План_дисциплин.Дисциплина_id
	JOIN Тип_занятия ON Тип_занятия.id = План_дисциплин.Тип_занятия_id
